...
public class Practical2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("We got the requested \"HELLO WORLD\" gene in the generation: " + generationCounter);
		System.out.println("When the mutation rate was: " + mutationRate);
